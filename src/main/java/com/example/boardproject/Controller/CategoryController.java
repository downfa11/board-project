...
import com.example.boardproject.Service.CategoryServiceImplement;
...
public class CategoryController {
    ...
    public CategoryController(CategoryServiceImplement categoryService){
    ...
    public void updateCategory(String accountId,
                               ...
                               @PathVariable CategoryRequest categoryRequest){
        CategoryDTO categoryDTO = new CategoryDTO(
                categoryId, categoryRequest.getName(),
